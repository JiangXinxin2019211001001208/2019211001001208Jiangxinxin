		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.JiangXinxin.model.Order o=(com.JiangXinxin.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("dbConn");
						com.JiangXinxin.dao.UserDao userDao=new com.JiangXinxin.dao.UserDao();
					...
					<td class="cart_total">${o.paymentId}
						<%
							...
							String paymentType=com.JiangXinxin.model.Payment.findByPaymentId(con,n);
						%>
