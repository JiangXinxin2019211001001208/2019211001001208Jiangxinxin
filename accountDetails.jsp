						...
						<c:otherwise>
							...
							<c:forEach var="o" items="${orderList}">
								<tr>
									...
									<td class="cart_total">
										<%
											com.Pengyanlong.model.Order o=(com.Pengyanlong.model.Order)pageContext.findAttribute("o");
											int n=o.getPaymentId();
											java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
											String paymentType=com.Pengyanlong.model.Payment.findByPaymentId(con,n);
										%>
